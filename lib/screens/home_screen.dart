          ...
          child: Padding(
            ...
            child: ValueListenableBuilder<List<TransactionItem>>(
              ...
              builder: (context, txList, _) {
                ...
                final incomePercent = totalActivity > 0
                    ? (incomeTotal / totalActivity).clamp(0.0, 1.0)
                    : 0.0;
                final expensePercent = totalActivity > 0
                    ? (expenseTotal / totalActivity).clamp(0.0, 1.0)
                    : 0.0;

                // Top spending categories (only expenses)
                final categoryTotals =
                    storage.categoryTotalsForMonth(year, month);
